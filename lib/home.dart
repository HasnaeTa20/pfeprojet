...
class _CreationArtState extends State<CreationArt> {
  ...
  void updateFilteredList(String query) {
    setState(() {
      if (query.isNotEmpty) {
        filteredList = contr.users
            .where(
                (user) => user.nom!.toLowerCase().contains(query.toLowerCase()))
            .toList();
      } else {
        filteredList = contr.users;
      }
        ...
        Column(
          ...
          children: <Widget>[
            Padding(
              ...
              child: TextFormField(
                validator: (val) =>
                    val == "" ? "s'il vous plaît ecrire votre nom " : null,
            ...
            Expanded(
              child: Obx(() {
                ...
                final user =
                    controller.text.isNotEmpty ? filteredList : contr.users;
                                  ...
                                  (user) => DataRow(cells: [
                                    ...
                                    DataCell(
                                      CircleAvatar(
                                        radius: 20,
                                        backgroundColor:
                                            Color.fromARGB(255, 160, 248, 149),
                                        child: IconButton(
